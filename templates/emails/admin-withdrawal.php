...
printf(
	...
	esc_html__( 'Il cliente %s ha inviato una richiesta di recesso.', 'woocommerce-easy-withdrawal' ),
...
<table cellspacing="0" cellpadding="6" style="width:100%;border-collapse:collapse;margin-bottom:20px;">
	<tr>
		<th style="text-align:left;background:#f8f8f8;padding:8px 10px;border-bottom:1px solid #e8e8e8;width:160px;"><?php esc_html_e( 'Ordine', 'woocommerce-easy-withdrawal' ); ?></th>
	...
	<tr>
		<th style="text-align:left;background:#f8f8f8;padding:8px 10px;border-bottom:1px solid #e8e8e8;"><?php esc_html_e( 'Cliente', 'woocommerce-easy-withdrawal' ); ?></th>
	...
	<tr>
		<th style="text-align:left;background:#f8f8f8;padding:8px 10px;border-bottom:1px solid #e8e8e8;"><?php esc_html_e( 'Totale ordine', 'woocommerce-easy-withdrawal' ); ?></th>
		<td style="padding:8px 10px;border-bottom:1px solid #e8e8e8;"><?php echo wp_kses_post( $order->get_formatted_order_total() ); ?></td>
	</tr>
	<tr>
		<th style="text-align:left;background:#f8f8f8;padding:8px 10px;border-bottom:1px solid #e8e8e8;"><?php esc_html_e( 'Data richiesta', 'woocommerce-easy-withdrawal' ); ?></th>
	...
	<tr>
		<th style="text-align:left;background:#f8f8f8;padding:8px 10px;"><?php esc_html_e( 'Da rimborsare', 'woocommerce-easy-withdrawal' ); ?></th>
...
<h2><?php esc_html_e( 'Prodotti da restituire', 'woocommerce-easy-withdrawal' ); ?></h2>
<table cellspacing="0" cellpadding="6" style="width:100%;border-collapse:collapse;margin-bottom:20px;">
	<thead>
		<tr>
...
<p>
	<a href="<?php echo esc_url( $order->get_edit_order_url() ); ?>"
	   style="display:inline-block;padding:10px 20px;background:#1f3864;color:#fff;text-decoration:none;border-radius:3px;font-weight:600;">
		<?php esc_html_e( 'Gestisci ordine →', 'woocommerce-easy-withdrawal' ); ?>
	</a>
</p>
